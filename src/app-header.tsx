...
export function AppHeader({
  ...
  return (
    <header
      className={cx('flex items-center h-12 flex-none px-3', bordered && 'border-b border-line')}
    ...
    >
      ...
      <div
        ...
        style={{ width: siderCollapsed ? 99 : 0, marginLeft: siderCollapsed ? '6px' : 0 }}
        aria-hidden={!siderCollapsed}
        data-tauri-drag-region
      >
        <div className="flex-none w-[72px] self-stretch" data-tauri-drag-region />
        <Tooltip title={t('expandSider')} placement="right">
          <button
            type="button"
