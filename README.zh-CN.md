...
- **文件夹对比** —— 递归比对两个目录，列出新增 / 修改 / 删除，点开任一文件进入逐行 diff。
- **Git 对比** —— 对比任意两个 ref（含工作区），浏览变更文件列表（含重命名检测）与逐行 diff，可检出单文件。
...
| 文本对比 | 文件夹对比 |
| --- | --- |
| ![文本对比](./docs/images/text-light.png) | ![文件夹对比](./docs/images/folder-tree-light.png) |
| **并排文件 diff** | **Git 对比** |
| ![并排文件 diff](./docs/images/folder-file-light.png) | ![Git 对比](./docs/images/git-tree-light.png) |
